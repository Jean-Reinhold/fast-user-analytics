...
# fast_user_analytics documentation build
...
from fast_user_analytics import __version__ as release

# -- Project information -----------------------------------------------------

project = "fast_user_analytics"
author = "Kedro"
...
htmlhelp_basename = "fast_user_analyticsdoc"
...
latex_documents = [
    (
        master_doc,
        "fast_user_analytics.tex",
        "fast_user_analytics Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "fast_user_analytics",
        "Project fast_user_analytics codebase.",
        "Data-Science",
    )
]
